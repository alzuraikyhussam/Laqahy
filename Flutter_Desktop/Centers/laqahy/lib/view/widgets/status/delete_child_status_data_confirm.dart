...
class DeleteChildStatusConfirm extends StatelessWidget {
  DeleteChildStatusConfirm({super.key, required this.childId});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Obx(() {
                  return csc.isDeleteLoading.value
                      ? myLoadingIndicator()
                      : Expanded(
                          child: myButton(
                            backgroundColor: MyColors.redColor,
                            onPressed: csc.isDeleteLoading.value
                                ? null
                                : () {
                                    csc.deleteChildStatusData(
                                      childId,
                                    );
                                  },
                            text: 'حـــــذف',
