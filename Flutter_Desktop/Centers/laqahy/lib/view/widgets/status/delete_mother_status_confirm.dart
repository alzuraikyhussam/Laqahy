...
class DeleteMotherStatusConfirm extends StatelessWidget {
  DeleteMotherStatusConfirm({super.key, required this.motherId});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Obx(() {
                  return msc.isDeleteLoading.value
                      ? myLoadingIndicator()
                      : Expanded(
                          child: myButton(
                            backgroundColor: MyColors.redColor,
                            onPressed: msc.isDeleteLoading.value
                                ? null
                                : () {
                                    msc.deleteMotherStatusData(
                                      motherId,
                                    );
                                  },
                            text: 'حـــــذف',
